...
import hu.scs.enaplo.dto.response.RemarkResponseDTO;
import hu.scs.enaplo.model.Remark;
import hu.scs.enaplo.service.impl.RemarkServiceImpl;

import java.util.List;

/**
 * The {@link RemarkController} contains all rest api function that need to
 * manage the {@link hu.scs.enaplo.model.Remark}.
 *
 * @see hu.scs.enaplo.model.Remark
 * @see hu.scs.enaplo.service.impl.RemarkServiceImpl
 */
@RestController
