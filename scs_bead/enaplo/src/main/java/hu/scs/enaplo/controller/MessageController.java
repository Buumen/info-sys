...
import hu.scs.enaplo.dto.response.MessageResponseDTO;
import hu.scs.enaplo.model.Message;
import hu.scs.enaplo.service.impl.MessageServiceImpl;

import java.util.List;

/**
 * The {@link MessageController} contains all rest api function that need to
 * manage the {@link hu.scs.enaplo.model.Message}.
 *
 * @see hu.scs.enaplo.model.Message
 * @see hu.scs.enaplo.service.impl.MessageServiceImpl
 */
@RestController
